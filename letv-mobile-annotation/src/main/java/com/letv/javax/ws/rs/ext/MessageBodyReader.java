 ...
 * with {@link com.letv.javax.ws.rs.Consumes} to restrict the media types for which it will
 ...
 * @author Marc Hadley
 * @see Provider
 * @see com.letv.javax.ws.rs.Consumes
 * @since 1.0
 */
public interface MessageBodyReader<T> {
     ...
     * Java representation of a zero-length entity or throw a {@link com.letv.javax.ws.rs.core.NoContentException}
     ...
     * request entity, is automatically translated by JAX-RS server runtime into a {@link com.letv.javax.ws.rs.BadRequestException}
     * wrapping the original {@code NoContentException} and rethrown for a standard processing by
     * the registered {@link com.letv.javax.ws.rs.ext.ExceptionMapper exception mappers}.
     * </p>
     *
     ...
     *         a {@link com.letv.javax.ws.rs.core.NoContentException} in case no zero-length entity representation is
    ...
    public T readFrom(Class<T> type, Type genericType,
                      ...
                      InputStream entityStream) throws java.io.IOException, com.letv.javax.ws.rs.WebApplicationException;
}

 ...
 * by JAX-RS runtime.
 * If there is a {@link com.letv.javax.ws.rs.NameBinding &#64;NameBinding} annotation
 * applied to the filter, the filter will also be executed at the <i>post-match</i>
 * request extension point, but only in case the matched {@link com.letv.javax.ws.rs.HttpMethod
 ...
 * @see PreMatching
 * @see com.letv.javax.ws.rs.container.ContainerResponseFilter
 * @since 2.0
 */

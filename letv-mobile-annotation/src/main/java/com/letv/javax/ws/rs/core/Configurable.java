 ...
 * or {@link com.letv.javax.ws.rs.container.DynamicFeature} meta-providers) or can be directly represented
 * by a concrete JAX-RS component implementing the {@code Configurable} interface
 * (such as {@link com.letv.javax.ws.rs.client.Client} or {@link com.letv.javax.ws.rs.client.WebTarget}).
...
public interface Configurable<C extends Configurable> {
     ...
     * a {@link com.letv.javax.ws.rs.core.Feature feature} meta-provider) to be instantiated
     ...
     * meta-provider contracts, such as {@code Feature} or {@link com.letv.javax.ws.rs.container.DynamicFeature}.
     * <p>
     ...
     * {@code com.wxxr.javax.annotation.Priority} annotation is overridden with the supplied
     * {@code priority} value.
     * </p>
     * <p>
     ...
     * except that any priority specified on the registered JAX-RS component class via
     * {@code com.wxxr.javax.annotation.Priority} annotation is overridden

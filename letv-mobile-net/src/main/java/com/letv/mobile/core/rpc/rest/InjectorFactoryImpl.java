...
import static com.letv.mobile.core.rpc.rest.FindAnnotation.findAnnotation;
...
import com.letv.javax.ws.rs.container.Suspended;
import com.letv.javax.ws.rs.core.Context;
import com.letv.mobile.core.rpc.rest.annotation.Form;
...
//      }
      ...
      else if (com.letv.javax.ws.rs.container.AsyncResponse.class.isAssignableFrom(type))
      {
         return new AsynchronousResponseInjector();
      }
      else if (useDefault)

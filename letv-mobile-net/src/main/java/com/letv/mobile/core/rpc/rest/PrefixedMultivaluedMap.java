...
/**
 * {@link com.wxxr.javax.ws.rs.core.MultivaluedMap} implementation that wraps another instance and only returns values that are prefixed with the given {@link #prefix}.
 *

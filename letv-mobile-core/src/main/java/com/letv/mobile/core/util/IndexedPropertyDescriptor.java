...
perty.
	...
	if (indexedReadMethod == null) {
	    ...
	    indexedReadMethod = JavaBeanIntrospector.findMethod(cls, indexedReadMethodName, 
							1, args);
	    if (indexedReadMethod == null) {
	...
	if (indexedWriteMethod == null) {
	    ...
	    indexedWriteMethod = JavaBeanIntrospector.findMethod(cls, indexedWriteMethodName, 

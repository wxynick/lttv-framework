...
import com.letv.mobile.core.rpc.http.api.HttpEntity;
...
public final class EntityUtils {
     ...
     */
    public static String getContentCharSet(final HttpEntity entity) throws IOException {
        if (entity == null) {
            throw new IllegalArgumentException("HTTP entity may not be null");
        }
        String charset = null;
        if (entity.getContentType() != null) {
            HeaderElement values[] = HeaderValueParser.parseElements(entity.getContentType());
            if (values.length > 0) {
     ...
     * @since 4.1
     */
    public static String getContentMimeType(final HttpEntity entity) throws IOException {
        if (entity == null) {
            throw new IllegalArgumentException("HTTP entity may not be null");
        }

/*
 * $HeadURL: https://svn.apache.org/repos/asf/httpcomponents/httpcore/tags/4.0.1/httpcore/src/main/java/org/apache/http/message/BasicHeaderValueParser.java $
 * $Revision$
 * $Date$
 *
 * ====================================================================
...
public class HeaderValueParser  {
     ...
     */
    public final static
        HeaderValueParser DEFAULT = new HeaderValueParser();
    ...
    public final static HeaderElement[] parseElements(final String value)
        ...
        HeaderValueParser parser = HeaderValueParser.DEFAULT;
    ...
    public HeaderElement[] parseElements(final StringBuffer buffer,
    ...
    // non-javadoc, see interface HeaderValueParser
    public HeaderElement parseHeaderElement(final StringBuffer buffer,
                                            final ParserCursor cursor) {
    ...
    // non-javadoc, see interface HeaderValueParser
    public NameValuePair[] parseParameters(final StringBuffer buffer,
                                           final ParserCursor cursor) {
    ...
    // non-javadoc, see interface HeaderValueParser
    public NameValuePair parseNameValuePair(final StringBuffer buffer,
                                            final ParserCursor cursor) {
    ...
    public NameValuePair parseNameValuePair(final StringBuffer buffer,
        ...
        if (pos == indexTo) {
            terminated = true;
            name = buffer.substring(indexFrom, indexTo);
        } else {
            name = buffer.substring(indexFrom, pos);
            pos++;
        }
